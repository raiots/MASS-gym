...
{
	py::class_<Environment>(m,"pyEnv")
		.def(py::init())
		.def("Initialize",static_cast<void (Environment::*)()>(&Environment::Initialize))
		.def("Initialize",static_cast<void (Environment::*)(const std::string&,bool)>(&Environment::Initialize))
		.def("Step",&Environment::Step)
		.def("Reset",&Environment::Reset)
		.def("IsEndOfEpisode",&Environment::IsEndOfEpisode)
		.def("GetState",&Environment::GetState)
		.def("SetAction",&Environment::SetAction)
		.def("GetReward",&Environment::GetReward)
		...
		.def("GetControlHz",&Environment::GetControlHz)
		.def("GetSimulationHz",&Environment::GetSimulationHz)
		.def("GetNumTotalRelatedDofs",&Environment::GetNumTotalRelatedDofs)
		.def("GetMuscleTuples",&Environment::GetMuscleTuples)
		.def("GetMuscleTuples_JtA", &Environment::GetMuscleTuples_JtA)
		.def("GetMuscleTuples_L", &Environment::GetMuscleTuples_L)
		.def("GetMuscleTuples_b", &Environment::GetMuscleTuples_b)
		.def("GetMuscleTuples_tau_des", &Environment::GetMuscleTuples_tau_des)
		.def("GetNumState",&Environment::GetNumState)
		.def("GetNumAction",&Environment::GetNumAction)
		.def("GetNumSteps",&Environment::GetNumSteps)
		.def("GetUseMuscle",&Environment::GetUseMuscle)
		.def("SetUseMuscle",&Environment::SetUseMuscle)
		.def("SetControlHz",&Environment::SetControlHz)
		.def("SetSimulationHz",&Environment::SetSimulationHz)
		.def("SetCharacter",&Environment::SetCharacter)
		.def("SetGround",&Environment::SetGround)
		.def("SetRewardParameters",&Environment::SetRewardParameters);
}